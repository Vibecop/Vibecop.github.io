...
export const STORY = [
  "Vibecop is an AI-built software audit service: senior engineers reviewing applications built with AI coding tools before those applications carry real users, real data, or real money. It started from a pattern we kept seeing: founders shipping fast with Claude Code, Cursor, Lovable, and Bolt, and no senior engineer reviewing what actually went out. AI generates code fast it doesn’t own the consequences. Technical debt, exposed endpoints, and architecture that quietly fails at scale accumulate from day one, invisible until they surface in an enterprise security review, in investor due diligence, or in a production incident.",
