...
/**
 * The 48–72 hour delivery timeline: the artwork on one side, the drawn rail on
    ...
    <div className="velocity-feature-grid">
      ...
      <div className="velocity-feature-copy" data-reveal="right">
        ...
        <h2 className="text-h1">
          The 48-72 Hour Production Readiness Plan
          <button
            type="button"
            className="tip-mark"
            aria-label="About the 48-72 hour window"
        ...
        <p className="velocity-feature-note">
          Typical scope-to-handoff time on a working-hours clock. Larger or more tangled codebases
